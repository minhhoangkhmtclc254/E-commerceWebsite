...
<body style="background-color:#a2a4a4">
    ...
    if($_SERVER["REQUEST_METHOD"] === "GET"){
        ...
        echo'<form action="includes/productupdate.inc.php?updateid='.$productId.'" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label for="productName">Product Name</label>
                <input type="text" name="productName" class="form-control" placeholder="Name" autocomplete="off">
            </div>
            <div class="form-group">
